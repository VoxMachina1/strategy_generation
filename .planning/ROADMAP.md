...
- [ ] **Phase 5: Validation Framework** - Walk-forward evaluation with crisis hold-out, stripped Sharpe, and regime analysis
- [ ] **Phase 5b: Tail Analysis Automation** - Port compute_tail_metrics() and automate for all validated signals
- [ ] **Phase 6: Monte Carlo Integration** - Port MC simulation and wire to pipeline output
- [ ] **Phase 7: RSI Search Entry Point** - Implement fast rsi_search.py entry point
- [ ] **Phase 8: Composer Export** - Fix signal name parser, Type 1 leaf insertion, Type 2 root wrapping, Mode C
- [ ] **Phase 9: Output and Report Generation** - CSV outputs, HTML dashboard, Composer JSON, Analysis Workshop port
...
| 5. Validation Framework | 0/TBD | Pending |
| 5b. Tail Analysis Automation | 0/TBD | Pending |
| 6. Monte Carlo Integration | 0/TBD | Pending |
| 7. RSI Search Entry Point | 0/TBD | Pending |
| 8. Composer Export | 0/TBD | Pending |
| 9. Output and Report Generation | 0/TBD | Pending |
